# Literally gotten from:
# $> wget https://raw.githubusercontent.com/rbarrois/python-semanticversion/refs/heads/master/semantic_version/base.py
#
# All credits and HUGE thanks to https://github.com/rbarrois/python-semanticversion
# I did not want yet-another-external-dependency and this is mighty good enough for local use
#
# -*- coding: utf-8 -*-
